...
namespace Lab14_3_
{
    public partial class Form1 : Form
    {
            ...
            if (chekon == false)
            {
                ...
                switch (k)
                {
                    case 1:
                        ...
                        else button1.Location = new Point(n.Next(gran), n.Next(gran));
                        break;
                    case 2:
                        if (button1.Location.X < (757 - 66))
                        {
                ...
                if ((button1.Left + button1.Width) > this.ClientSize.Width) button1.Left = this.ClientSize.Width - button1.Width;
                if (button1.Top < 50) button1.Top = 50;
                if ((button1.Top + button1.Height) > this.ClientSize.Height) button1.Top = this.ClientSize.Height - button1.Height;
            }
        }
        ...
        {
            if (e.KeyCode == Keys.Up || e.KeyCode == Keys.Down || e.KeyCode == Keys.Right || e.KeyCode == Keys.Left) e.IsInputKey = true;
        }
